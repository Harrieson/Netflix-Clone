    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            ...
            <div className="opacity-0 absolute top-0 transition duration-200 
                    ...
                    " src={data.thumbnailUrl} alt="thumbnail " />
                    <div className="z-10 bg-zinc-700 p-2 lg:p-4 absolute w-full transition shadow-md rounded-b-md">
                        <div className="flex flex-row items-center gap-3">
                            <div className="cursor-pointer w-6 h-6 lg:h-10 lg:w-10 
                            ...
                            <div className="cursor-pointer ml-auto group/item 
                                            w-6 h-6 lg:w-10 lg:h-10 border-white
